...
public enum Jobs {
    MECHANIC("기계 업체 대표", "밤 시간에 대상자의 방에 누가 있었는지 확인이 가능하다."),
    CLERK("행정 업체 대표", "모든 투표에서 나의 표는 2표로 취급된다."),
    ACCOUNTING("회계 업체 대표", "매 라운드 50% 확률로 대상자가 괴도인지 아닌지 본인만 알 수 있다."),
    SECURITY("보안 업체 대표", "대상자의 직업을 확인할 수 있다. 단, 진짜와 가짜 직업 2가지가 함께 제시된다."),
    INTERNET("인터넷 업체 대표", "밤 시간에 방 최대 인원제한 상관없이 난입이 가능하다."),
    CITIZEN("시민 대표", "게임 중 <대상자 침묵 1회권>과 <피고인투표 회피 1회권>을 하나씩 지급받는다."),
    ARCHITECT("건축 업체 대표", "매 라운드 금고 2군데 중 진짜 금괴가 위치할 금고 1군데를 선택할 수 있다."),
    GUARD("경비 업체 대표", "항상 첫 번째 조에 배치되며, 열쇠 아이템을 이용해 금고를 잠가 그 상자를 열 수 없게 할 수 있다."),
